...
console.log(containsW('This is a test'));
...
return true if the input contains a number, 
...
console.log(isNum(12345)); // Output: true
console.log(isNum('12345')); // Output: true
console.log(isNum('h3llo world')); // Output: true
console.log(isNum('hello world')); // Output: false
